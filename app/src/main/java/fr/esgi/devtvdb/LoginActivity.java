...
/**
 * A login screen that offers login via token/password.
 */
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_login);
            ...
            mPasswordView = (EditText) findViewById(R.id.identifier);
    ...
    private void attemptLogin(User user) {
        ...
        // Check for a valid token address.
...
//    }
    ...
    public Loader<Cursor> onCreateLoader(int i, Bundle bundle) {
        return new CursorLoader(this,
                ...
                // Select only token addresses.
                ContactsContract.Contacts.Data.MIMETYPE +
                        " = ?", new String[]{ContactsContract.CommonDataKinds.Email
                .CONTENT_ITEM_TYPE},

                // Show primary token addresses first. Note that there won't be
                // a primary token address if the user hasn't specified one.
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        UserLoginTask(String username, String identifier, Context aContext) {
            mUsername = username;
